...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Grupos</h1>
...
<div class="content">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="/autorizacao/grupos/permissoes/inserir/{{$key->id}}"> 
                                <button type="button" class="btn btn-sm btn-success" data-toggle="tooltip" title="Editar">
    ...
    <div class="block block-rounded">
        ...
        @endif
        <div class="block-header block-header-default">
            <h3 class="block-title">Cadastro de Grupos</h3>
        </div>
        <div class="block-content block-content-full">
